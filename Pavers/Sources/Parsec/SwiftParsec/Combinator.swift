...
/**
    ...
    parser.
*/
public func choice<Result, Input, UserInfo>
  (_ ps: [UserParserClosure<Result, Input, UserInfo>])
...
*/
public func option<Result, Input, UserInfo>
  (_ x: Result,
...
*/
public func optionMaybe<Result, Input, UserInfo>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>)
  -> UserParserClosure<Result?, Input, UserInfo> {
...
/**
    ...
    of `p`.
*/
public func optional<Result, Input, UserInfo>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>)
...
*/
public func between<ResultA, Input, UserInfo, ResultX, ResultY>
  (_ open: @escaping UserParserClosure<ResultX, Input, UserInfo>,
   _ close: @escaping UserParserClosure<ResultY, Input, UserInfo>,
...
/**
    ...
    its result.
*/
public func skipMany1<Result, Input, UserInfo>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>)
  -> UserParserClosure<(), Input, UserInfo> {
  return p >>> skipMany(p)
}
...
*/
public func many1<Result, Input, UserInfo>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>)
  -> UserParserClosure<[Result], Input, UserInfo> {
  return p >>- { x in
    many(p) >>- { xs in
...
*/
public func sepBy<Result, Input, UserInfo, ResultX>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ sep: @escaping UserParserClosure<ResultX, Input, UserInfo>)
  -> UserParserClosure<[Result], Input, UserInfo> {
...
/**
    ...
    by `sep`. Returns a list of values returned by `p`.
*/
public func sepBy1<Result, Input, UserInfo, ResultX>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ sep: @escaping UserParserClosure<ResultX, Input, UserInfo>)
  -> UserParserClosure<[Result], Input, UserInfo> {
  return p >>- { x in
...
/**
    ...
    returned by `p`.
*/
public func sepEndBy1<Result, Input, UserInfo, ResultX>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ sep: @escaping UserParserClosure<ResultX, Input, UserInfo>)
  -> UserParserClosure<[Result], Input, UserInfo> {
  return p >>- { x in
...
*/
public func sepEndBy<Result, Input, UserInfo, ResultX>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ sep: @escaping UserParserClosure<ResultX, Input, UserInfo>)
  -> UserParserClosure<[Result], Input, UserInfo> {
...
*/
public func endBy1<Result, Input, UserInfo, ResultX>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ sep: @escaping UserParserClosure<ResultX, Input, UserInfo>)
  -> UserParserClosure<[Result], Input, UserInfo> {
...
/**
    ...
    and ended by `sep`. Returns a list of values returned by `p`.
*/
public func endBy<Result, Input, UserInfo, ResultX>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ sep: @escaping UserParserClosure<ResultX, Input, UserInfo>)
  -> UserParserClosure<[Result], Input, UserInfo> {
...
*/
public func count<Result, Input, UserInfo>
  (_ n: Int,
   _ p: @escaping UserParserClosure<Result, Input, UserInfo>)
  -> UserParserClosure<[Result], Input, UserInfo> {
  if n <= 0 {
...
func sequence<Result, Input, UserInfo>
  (_ ps: ArraySlice<UserParserClosure<Result, Input, UserInfo>>)
  -> UserParserClosure<[Result], Input, UserInfo> {
  if let p = ps.first {
    return p >>- { x in
...
/**
    ...
    returned.
*/
public func chainr<Result, Input, UserInfo>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ op: @escaping UserParserClosure<(Result, Result) -> Result, Input, UserInfo>, _ x: Result)
  -> UserParserClosure<Result, Input, UserInfo> {
...
/**
    ...
    returned.
*/
public func chainl<Result, Input, UserInfo>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ op: @escaping UserParserClosure<(Result, Result) -> Result, Input, UserInfo>, _ x: Result)
  -> UserParserClosure<Result, Input, UserInfo> {
...
*/
public func chainl1<Result, Input, UserInfo>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ op: @escaping UserParserClosure<(Result, Result) -> Result, Input, UserInfo>)
  -> UserParserClosure<Result, Input, UserInfo> {
  func rest (_ x: Result) -> UserParserClosure<Result, Input, UserInfo> {
    return op >>- { f in
      p >>- { y in
        rest(f(x, y))
      }
...
/**
    ...
    by `p`.
*/
public func chainr1<Result, Input, UserInfo>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ op: @escaping UserParserClosure<(Result, Result) -> Result, Input, UserInfo>)
  -> UserParserClosure<Result, Input, UserInfo> {
  func scan () -> UserParser<Result, Input, UserInfo> {
    return (p >>- rest)()
  }
  func rest (_ x: Result) -> UserParserClosure<Result, Input, UserInfo> {
    return op >>- { f in
...
*/
public func anyToken<Input: Collection, UserInfo>
  ()
  -> UserParser<Input.Iterator.Element, Input, UserInfo>
...
*/
public func eof<Input: Collection, UserInfo> () -> UserParser<(), Input, UserInfo>
  where Input.SubSequence == Input {
...
*/
public func notFollowedBy<Result, Input, UserInfo>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>)
  -> UserParserClosure<(), Input, UserInfo> {
  return attempt(
...
*/
public func manyTill<Result, Input, UserInfo, ResultX>
  (_ p: @escaping UserParserClosure<Result, Input, UserInfo>,
   _ end: @escaping UserParserClosure<ResultX, Input, UserInfo>)
  -> UserParserClosure<[Result], Input, UserInfo> {
  func scan () -> UserParser<[Result], Input, UserInfo> {
    return (end >>> create([]) <|> p >>- { x in scan >>- { xs in  create([x] + xs) } })()
  }
  return scan
}
