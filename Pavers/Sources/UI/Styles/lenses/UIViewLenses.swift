...
public extension LensHolder where Object: UIViewProtocol {
  ...
  func contentStrethinessResistancePriority(for axis: NSLayoutConstraint.Axis)
    -> Lens<Object, UILayoutPriority> {
...
//  }
  ...
  var transform: Lens<Object, CGAffineTransform> {
    return Lens(
      view: { $0.transform },
...
public extension Lens where Whole: UIViewProtocol, Part == CALayer {
  ...
  var rasterizationScale: Lens<Whole, CGFloat> {
    return Whole.lens.layer>>>CALayer.lens.rasterizationScale
  }

  var transform3D: Lens<Whole, CATransform3D> {
