...
public extension LensHolder where Object: UIButtonProtocol {
  ...
  public func attributedTitle(forState state: UIControl.State) -> Lens<Object, NSAttributedString> {
    return Lens(
  ...
  public func backgroundColor(forState state: UIControl.State) -> Lens<Object, UIColor> {
    return Lens(
      view: { _ in .clear },
  ...
  public func backgroundImage(forState state: UIControl.State) -> Lens<Object, UIImage?> {
    return Lens(
  ...
  public func image(forState state: UIControl.State) -> Lens<Object, UIImage?> {
    return Lens(
  ...
  public func titleColor(forState state: UIControl.State) -> Lens<Object, UIColor> {
    return Lens(
  ...
  public func title(forState state: UIControl.State) -> Lens<Object, String?> {
    return Lens(
